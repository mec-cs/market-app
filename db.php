...
function getAllProductsByPageNumber($start, $end, $city, $district){
     ...
     (SELECT p_id, p_name, p_stock, p_expire, c_id, p_image, p_price, MIN(UnionSet) UnionSetOrder 
     FROM
          ...
          SELECT p_id, p_name, p_stock, p_expire, e.c_id, p_image, p_price, 2 as UnionSet FROM product_table e JOIN company_table b ON b.c_id = e.c_id JOIN address_table a ON b.c_address_table = a.id WHERE a.city = ?
          ) x 
